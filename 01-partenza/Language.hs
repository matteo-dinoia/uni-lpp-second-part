...
data Term where
    ...
    Tdiv :: Term -> Term -> Term --divisione tra termini
    deriving (Show)

-- Interprete ovvio basato sulla funzione built-in Prelude.div
term2Int :: Term -> Integer
term2Int (Tcon b)    = bN2Int b
term2Int (Tdiv t t') = Prelude.div (term2Int t ) (term2Int t')
